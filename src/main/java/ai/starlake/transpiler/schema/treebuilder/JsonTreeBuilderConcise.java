...
public class JsonTreeBuilderConcise extends TreeBuilder<String> {
  private final StringBuilder jsonBuilder = new StringBuilder();
  private JSQLColumResolver resolver;

  public JsonTreeBuilderConcise(JdbcResultSetMetaData resultSetMetaData) {
  ...
  private void convertNodeToJson(JdbcColumn column, String alias) {
    ...
    if (expression instanceof Select) {
      ...
      try {
        jsonBuilder
            .append(resolver.getLineage(this.getClass(), select));
