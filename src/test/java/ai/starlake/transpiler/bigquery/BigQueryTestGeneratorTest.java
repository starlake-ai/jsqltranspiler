...
public class BigQueryTestGeneratorTest extends JSQLTranspilerTest {
    public final static String INPUT_FOLDER_STR =
            "build/resources/test/ai/starlake/test_generator/bigquery";
    public final static String TEST_FOLDER_STR =
            "src/test/resources/ai/starlake/transpiler/bigquery";

    private static final JSQLTranspiler.Dialect INPUT_DIALECT = JSQLTranspiler.Dialect.GOOGLE_BIG_QUERY;
    private static final JSQLTranspiler.Dialect OUTPUT_DIALECT = JSQLTranspiler.Dialect.DUCK_DB;
